...
export default function ProcessPayment({ billId, billData, onPaymentProcessed }: ProcessPaymentProps) {
    ...
    const requiresApproval = role === 'staff' || (paymentMethod === 'Cheque' && role === 'manager');
        ...
        if (file) {
            ...
            if (isHeif) {
                try {
                    ...
                    toast({
                        title: "Notice",
                        description: "HEIF/HEIC preview not supported in this browser. Image will still upload.",
                        variant: "default"
                    });
                }
            } else {
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-2">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium">Rs. {billData.finalAmount.toFixed(2)}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span>Remaining Balance:</span>
                                    <span className="font-medium text-red-600">Rs. {billData.remainingBalance.toFixed(2)}</span>
                                </div>
                            </CardContent>
                        </Card>
                                ...
                                <Card className="border-orange-200 bg-orange-50">
                                    <CardContent className="p-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                <p className="font-medium text-orange-800">Approval Required</p>
                                                <p className="text-sm text-orange-700">
                                                    This payment will be submitted for admin approval before processing.
                                                </p>
                                            </div>
                                        </div>
                                    </CardContent>
                    ...
                    <DialogFooter>
                        ...
                        >
                            {loading ? "Processing..." : (requiresApproval ? "Submit for Approval" : "Process Payment")}
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
